...
def measure_region_intensities(sms):
    measurements = [
...
def main(config_fpath):
    ...
    for item in config.raw_config["to_process"]:
        ...
        output_fpath = output_dirpath/output_fname
        measurements = measure_region_intensities(sms)
        measurements.to_csv(output_fpath, index=False)
